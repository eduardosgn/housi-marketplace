...
function EditListing() {
    ...
    // Redirecionar se anúncio não for do user logado
    useEffect(() => {
        if(listing && listing.userRef !== auth.currentUser.uid) {
            toast.error('Você não pode editar esse anúncio...');
            navigate('/');
        };
    }, [listing, listing.userRef, auth.currentUser.uid]);

    //  Pegando dados do anúncio para editar
    useEffect(() => {
        setLoading(true);
        ...
        const fetchListing = async () => {
            ...
            if (docSnapshot.exists()) {
                ...
                navigate('/');
                toast.error('Anúncio não existe...');
            };
        };
